...
const bottomTitle = { textAlign: 'center', color: 'gray', fontFamily: 'Nanum Pen Script', fontSize: 80 }
...
function ServiceIntro (props) {
  return (
    <div style={topDiv}>
      ...
      {/* Typography  */}
      <Title level={1} style={bottomTitle}>{props.dateFrom}년 {props.location}</Title>
    </div>
  )
}
