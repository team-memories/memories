...
parser.add_argument("--N_out", type=int, default=7,
...
def main():
    ...
    save_out_folder = osp.join(osp.dirname(args.output), 'sr_vfi')
    ...
    for select_idxs in select_idx_list:
        ...
        for idx, name_idx in enumerate(out_idx):
            ...
            if save_imgs:
                ...
                cv2.imwrite(osp.join(save_out_folder, '{:05d}.png'.format(name_idx)), output)
