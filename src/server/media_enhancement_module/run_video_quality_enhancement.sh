...
ffmpeg -i "data/input.mp4" -vf scale=480:270 "data/input_scaled.mp4 -y" && \
ffmpeg -i "data/input_scaled.mp4" -vf hue=s=0 "data/input_bw.mp4 -y" && \
ffmpeg -i "data/input_bw.mp4" -vsync 0 "data/color_input/%06d.png -y" && \
